...
class WordCloud:
    ...
    def __init__(self, file_path, word_no, topic_number):
    ...
    def generate_word_clouds(self):
        ...
        def hlp_generate_word_cloud(topic_no):
            ...
            # Generate word cloud
            wc = WordCloudClass(background_color="white", colormap=black_cm, max_font_size=80, random_state=0,
    ...
    def generate_visualization(self, file_path):
        ...
        if self.word_clouds:
            ...
            for row, col in itertools.product(range(4), range(5)):
                ...
                axs[row][col].set_title(f"topic_{wc_id}")  # TODO: Replace with correct labels
