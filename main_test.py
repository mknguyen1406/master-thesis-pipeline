...
if __name__ == '__main__':
    ...
    #     "seed": 0,
    #     "num_topics": 20,
    #     "output_file_path": "models/dtm/200227_dtm_all_projects_20",
    #     "files": files
    # }
    ...
    # Get topic assignments per document TODO: Add topic vector to documents
    # doc_topic_no, doc_topic_vec = dtm_model.get_doc_topics(doc_term_matrix)
